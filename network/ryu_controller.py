...
class SimpleForwarding(app_manager.RyuApp):
    ...
    def add_flow(self, datapath, priority, match, actions, buffer_id=None):
        """Installs a flow rule on the switch with given match and actions"""
    ...
    def switch_features_handler(self, ev):
        """Handles switch features reply and installs table-miss flow entry."""
    ...
    def packet_in_handler(self, ev):
        """Handles PacketIn events: learns MAC -> port and decides forwarding."""
