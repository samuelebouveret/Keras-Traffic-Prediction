...
## Overview
In this repository we will configure and create a simple traffic prediction model using Keras. The data used for training is generated by a Mininet topology configurated Software Defined Network and RYU controller to feed the dataset. All of this is developed and tested inside the ComNetEmu environment<br>
